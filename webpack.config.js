...
module.exports = {
    ...
    module: {
        ...
        rules: [
            ...
            {
                // copying images over to /images folder of /build if referenced in SASS or CSS via url() or imported directly with js
            ...
            {
                // copying fonts over to /fonts folder of /build if referenced in SASS or CSS via url() or imported directly with js
    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [
                // copies all assets in the lib/ folder (images, etc) to /build (in case not imported manually via SCSS or CSS or JS)
